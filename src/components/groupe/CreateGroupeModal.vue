        ...
        <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div>
            ...
            <input v-model="form.nom" type="text" placeholder="Ex: Administrateurs, Livreurs, etc."
              class="w-full px-4 py-3 rounded-lg border border-gray-300 bg-white text-gray-900 placeholder:text-gray-400 focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500/20 transition-all dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder:text-gray-500"
          ...
          <!-- Info Box -->
          <div class="rounded-lg bg-green-50 p-3 border border-green-100 dark:bg-green-900/20 dark:border-green-900/30">
            <div class="flex gap-2">
              <svg class="h-4 w-4 text-green-600 dark:text-green-400 flex-shrink-0 mt-0.5" fill="none"
          ...
          <div class="flex gap-3 pt-4 border-t border-gray-200 dark:border-gray-800">
            ...
            <button type="submit" :disabled="isLoading || !form.nom.trim()"
              class="flex-1 inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-green-600 to-green-700 px-4 py-2.5 text-sm font-medium text-white hover:shadow-lg hover:shadow-green-600/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all">
