  ...
  <FullScreenLayout>
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      <div class="relative flex flex-col justify-center w-full h-screen lg:flex-row dark:bg-gray-900">
                ...
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      <input v-model="username" type="email" id="phone" name="username" placeholder="kenea@gmail.com" required
                ...
                <div class="mt-5">
                  <p class="text-sm font-normal text-center text-gray-700 dark:text-gray-400 sm:text-start">
                    ...
                    <router-link to="/signup"
                      class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Contactez-nous</router-link>
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="relative items-center hidden w-full h-full lg:w-1/2 dark:bg-white/5 lg:grid" style="
...
const { signIn, isLoading, error, successMessage } = useAuth()
const username = ref('')
const password = ref('')
