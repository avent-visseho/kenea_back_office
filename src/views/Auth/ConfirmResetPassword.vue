<!-- src/views/Auth/ConfirmResetPassword.vue -->
...
onMounted(() => {
  ...
  resetEmail.value = sessionStorage.getItem('reset_email') || ''

  // Si pas d'email en session, rediriger vers la page de demande
  if (!resetEmail.value) {
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (response.status === 'SUCCESS') {
      const successMsg = response.message || 'Mot de passe réinitialisé avec succès'
          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              <div class="mb-5 sm:mb-8">
                ...
                <p v-if="resetEmail" class="mt-2 text-sm font-medium text-brand-500 dark:text-brand-400">
                ...
                <form @submit.prevent="handleSubmit">
                  <div class="space-y-5">
                    ...
                    <div>
                      ...
                      >
                        Code de vérification<span class="text-error-500">*</span>
                      </label>
                      <input
                        v-model="code"
                        type="text"
